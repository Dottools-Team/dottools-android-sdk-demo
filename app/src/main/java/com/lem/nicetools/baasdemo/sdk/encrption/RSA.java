package com.lem.nicetools.baasdemo.sdk.encrption;
...
public class RSA {
    ...
    public static String encryptBase64(byte[] str, byte[] publicKey) {
        return Base64.encodeToString(encrypt(str, publicKey), 0);
    }
    ...
    public static byte[] decryptFromBase64(String str, byte[] privateKey) {
        return decrypt(Base64.decode(str,0 ), privateKey);
    }
    ...
    public static String signBase64(String data, byte[] privateKey) {
        return Base64.encodeToString(sign(data.getBytes(), privateKey), 0);
    }
    ...
    public static boolean verifyFromBase64(String data, byte[] publicKey, String sign) {
        return verify(data.getBytes(), publicKey, Base64.decode(sign, 0));
    }
    ...
    public static class RsaKeyPair {
        ...
        public String getPublicKeyBase64() {
            return Base64.encodeToString(publicKey,0 );
        }

        public String getPrivateKeyBase64() {
            return Base64.encodeToString(privateKey, 0);
        }
    }
